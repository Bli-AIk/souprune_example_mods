//! Bootstrapped code asset for `battle/rules/demo_battle.fre.ron`.
//!
//! `battle/rules/demo_battle.fre.ron` 的 bootstrap 代码资产。
...
pub fn emit(reg: &mut Registry) -> Result<()> {
    reg.emit_ron("battle/rules/demo_battle.fre.ron", &asset())?;
    Ok(())
}
