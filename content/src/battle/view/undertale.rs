    ...
    view_layout(vec![
        ...
        view_node("AttackBar")
            ...
            .view_box(
                view_box(8.0, 130.0)
                    .border_width(3.0)
                    .offset(vector3(-274.0, -80.5, 11.0))
